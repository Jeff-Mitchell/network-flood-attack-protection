# Version 3: Added Time Function To Track Packets per Second,
# For Logging And Prevent Application From Blocking Normal User Traffic After A Long Period Of Time
